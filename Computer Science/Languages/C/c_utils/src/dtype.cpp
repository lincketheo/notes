...
strtodtype_v (const char *str, dtype type)
{
  ...
  int isneg = 0;
  double f64val = 0.0;
  _Complex double cf128val = 0.0 + 0.0 * I;
  int mult;
  ...
  switch (type)
    ...
    case CHAR:
      ...
      break;
    case U8:
      result.v.u8 = (uint8_t)u64val;
      break;
    case U16:
      result.v.u16 = (uint16_t)u64val;
      break;
    case U32:
      result.v.u32 = (uint32_t)u64val;
      break;
    case U64:
      result.v.u64 = u64val;
      break;
    case I8:
      result.v.i8 = (int8_t)(mult * u64val);
      break;
    case I16:
      result.v.i16 = (int16_t)(mult * u64val);
      break;
    case I32:
      result.v.i32 = (int32_t)(mult * u64val);
      break;
    case I64:
      result.v.i64 = (int64_t)(mult * u64val);
      break;
    case F32:
      result.v.f32 = (float)f64val;
      break;
    case F64:
      result.v.f64 = f64val;
      break;
    case CF64:
      result.v.cf64 = cf128val;
      break;
    case CF128:
      result.v.cf128 = cf128val;
      break;
    }
...
failed:
  dtype_v_result failed_result = { 0 };
  failed_result.ok = 0;
