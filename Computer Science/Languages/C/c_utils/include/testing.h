...
#define TEST_ASSERT_STR_EQUAL(str1, str2)                                                    \
  if (strcmp (str1, str2) != 0)                                                              \
    {                                                                                        \
      fprintf (stderr, BOLD_RED "FAILED: " RESET RED "\"%s\" != \"%s\" " RESET, str1, str2); \
      TEST_REPORT ();                                                                        \
      ASSERT (0);                                                                            \
    }
...
#define TEST_EQUAL(left, right, fmt)                                                                                        \
  if (left != right)                                                                                                        \
    {                                                                                                                       \
      fprintf (stderr, BOLD_RED "FAILED: " RESET RED "%s != %s -- " fmt " != " fmt "\n" RESET, #left, #right, left, right); \
      TEST_REPORT ();                                                                                                       \
      ASSERT (0);                                                                                                           \
    }
...
#define TEST_FLOAT_EQUAL(left, right, tol)                                                                      \
  if (fabs (left - right) > tol)                                                                                \
    {                                                                                                           \
      fprintf (stderr, BOLD_RED "FAILED: " RESET RED "%s != %s, %f != %f\n" RESET, #left, #right, left, right); \
      TEST_REPORT ();                                                                                           \
      ASSERT (0);                                                                                               \
    }
