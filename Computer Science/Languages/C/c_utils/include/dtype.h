...
/**
 * @brief All int data types are between -UINT64 and UINT64 MAX. Smaller dtypes
 * are constrained
 * differently, for example, U32 is between 0 and U32 MAX. Checks if the
 * provided U64 (which is
 ...
 * @param blen The length (in bytes, not elements) - length must be a multiple
 *of dtype size
